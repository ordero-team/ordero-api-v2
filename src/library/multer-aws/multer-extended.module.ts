...
import { MulterExtendedS3AsyncOptions, MulterExtendedS3Options, MulterExtendedS3OptionsFactory } from './interfaces';
import { MulterConfigLoader } from './multer-config.loader';
import { createMulterExtendedProviders, createMulterOptionsFactory } from './multer-extended.providers';
...
export class MulterExtendedModule {
  ...
  private static createOptionsProvider(options: MulterExtendedS3AsyncOptions): Provider {
    ...
    return {
      provide: MULTER_EXTENDED_S3_OPTIONS,
      useFactory: async (optionsFactory: MulterExtendedS3OptionsFactory) => optionsFactory.createMulterExtendedS3Options(),
