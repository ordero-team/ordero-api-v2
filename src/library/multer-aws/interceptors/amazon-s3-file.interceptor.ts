...
import { MulterExtendedOptions, MulterModuleOptions } from '../interfaces';
...
export function AmazonS3FileInterceptor(fieldName: string, localOptions?: MulterExtendedOptions): Type<NestInterceptor> {
